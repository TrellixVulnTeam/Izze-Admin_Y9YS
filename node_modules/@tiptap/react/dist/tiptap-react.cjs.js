...
const NodeViewWrapper = props => {
    ...
    return (React__default['default'].createElement(Tag, { ...props, "data-node-view-wrapper": "", onDragStart: onDragStart, style: {
            ...props.style,
            whiteSpace: 'normal',
        } }));
};
...
const NodeViewContent = props => {
    const Tag = props.as || 'div';
    return (React__default['default'].createElement(Tag, { ...props, "data-node-view-content": "", style: {
            ...props.style,
            whiteSpace: 'pre-wrap',
        } }));
};
